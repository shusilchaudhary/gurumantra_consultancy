...
const socialLinks = [
  { icon: SocialFacebook, label: "Facebook",   href: "https://www.facebook.com/gurumantraeducational/", color: "#1877F2" },
  { icon: SocialInstagram, label: "Instagram",  href: "#",                                               color: "#E1306C" },
  { icon: SocialYoutube,  label: "YouTube",     href: "#",                                               color: "#FF0000" },
  { icon: SocialTiktok,   label: "TikTok",      href: "https://www.tiktok.com/@guru.mantra3",            color: "#010101" },
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex flex-col gap-3 mb-6">
              ...
              >
                ...
                <span className="group-hover:text-white transition-colors">+977-9802356302</span>
              </a>
              <a
              ...
              >
                ...
                <a href="https://share.google/TOTKV4Wefsk7MYnBf" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">
                  Chabahil Central Complex, 3rd Floor,<br />Kathmandu, Nepal
                </a>
              </div>
            </div>
