...
const LiIcon  = () => <svg width="13" height="13" viewBox="0 0 24 24" fill="currentColor"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"/><rect width="4" height="12" x="2" y="9"/><circle cx="4" cy="4" r="2"/></svg>;
      ...
      <div className="hidden md:block" style={{ background: "var(--primary)" }}>
        <div style={{
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 20 }}>
            <a href="tel:+97714000000" style={{ display: "flex", alignItems: "center", gap: 6, color: "inherit", textDecoration: "none" }}
              onMouseEnter={e => (e.currentTarget.style.color = "#fff")}
              onMouseLeave={e => (e.currentTarget.style.color = "rgba(255,255,255,0.82)")}>
              <Phone size={12} /> +977-01-4XXXXXX
            </a>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 14, opacity: 0.75 }}>
            {[["Facebook", <FbIcon key="fb"/>], ["Instagram", <IgIcon key="ig"/>], ["YouTube", <YtIcon key="yt"/>], ["LinkedIn", <LiIcon key="li"/>]].map(([label, icon]) => (
              <a key={label as string} href="#" aria-label={label as string}
      ...
      {mobileOpen && (
        ...
        >
          ...
          <div style={{
            ...
            <a href="tel:+97714000000" style={{ display: "flex", alignItems: "center", gap: 6, color: "var(--primary)", fontWeight: 600, textDecoration: "none" }}>
              <Phone size={13} /> +977-01-4XXXXXX
            </a>
          ...
          <div style={{ padding: "12px 16px 20px", borderTop: "1px solid #e8ecf0", display: "flex", flexDirection: "column", gap: 12 }}>
            ...
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
              <div style={{ display: "flex", gap: 16, color: "#9ca3af" }}>
                {[["Facebook", <FbIcon key="f"/>], ["Instagram", <IgIcon key="i"/>], ["YouTube", <YtIcon key="y"/>], ["LinkedIn", <LiIcon key="l"/>]].map(([lbl, icon]) => (
                  <a key={lbl as string} href="#" aria-label={lbl as string} style={{ color: "inherit", display: "flex" }}
                    onMouseEnter={e => (e.currentTarget.style.color = "var(--primary)")}
